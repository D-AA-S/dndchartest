...
public class RollCharScript : MonoBehaviour
{
    ...
    public void statroller(string stat)
    {
        ...
        switch (stat)
        {
            ...
            case "Dex":
                {
                    Pdat.instance.Pl.ability_dex = total;
                    acupdate();
                    break;
                }
            case "Con":
            ...
            case "Wis":
                {
                    Pdat.instance.Pl.ability_wis = total;
                    acupdate();
                    break;
                }
    ...
    public void acupdate()
    {
        ...
        int dexmod = (int)Pdat.instance.Pl.ability_dex;
        ...
        {
            int wismod = (int)Pdat.instance.Pl.ability_wis;
